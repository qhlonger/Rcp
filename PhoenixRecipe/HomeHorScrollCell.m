...
@interface HomeHorScrollCell()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>{
    
}
@end
@implementation HomeHorScrollCell
...
static NSString *HomeColCellID = @"HomeColCell";
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [collectionView registerClass:[HomeColCell class] forCellWithReuseIdentifier:HomeColCellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HomeColCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:HomeColCellID forIndexPath:indexPath];
