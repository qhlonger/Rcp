...
- (void)updatePositionWithString:(NSString *)string hudBounds:(CGRect)bounds
{
    ...
    self.hudView.backgroundColor = [UIColor colorWithRed:251/255.0f green:66/255.0f blue:84/255.0f alpha:1];
...
- (void)updateSubview
{
    ...
    self.hudView.backgroundColor = [UIColor colorWithRed:240/255.0f green:140/255.0f blue:55/255.0f alpha:1];
...
- (UIView *)hudView
{
    if (!_hudView) {
        ...
        _hudView.backgroundColor =[UIColor colorWithRed:240/255.0f green:140/255.0f blue:55/255.0f alpha:1] ;
